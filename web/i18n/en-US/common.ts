const translation = {
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  about: {
    ...
    nowAvailable: 'Version {{version}} is now available.',
    latestAvailable: 'Version {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
