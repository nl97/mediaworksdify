const translation = {
  ...
  externalAPIPanelDescription: 'The external knowledge API is used to connect to an external knowledge base and retrieve knowledge from that knowledge base.',
