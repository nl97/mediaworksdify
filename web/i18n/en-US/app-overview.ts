const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Or try the cloud version with free quote',
  },
  overview: {
    title: 'Overview',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see our <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
